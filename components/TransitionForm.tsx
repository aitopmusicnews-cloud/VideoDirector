...
const TransitionForm: React.FC<TransitionFormProps> = ({ formState, setFormState }) => {
  ...
  const handleInputChange = useCallback(
    (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
      ...
      let processedValue: string | number | 'horizontal' | 'vertical' | 'midjourney' | 'stable-diffusion-1.5' | 'flux-ai' = value;
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <SelectInput id="promptFormat" name="promptFormat" label="Image Prompt Format" value={formState.promptFormat} onChange={handleInputChange}>
